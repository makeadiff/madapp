...
class Admincredit extends controller {
    ...
    /*
     * Function Name : index()
     * Wroking :This function will show  all the users in the current city and their credits and Tasks.
     * @author:Rabeesh
     * @param :[]
     * @return: type: []
     */
     ...
     * Wroking :This function is used for viewing of all the users and Tasks in the current City.
     * @author:Rabeesh
     * @param :[]
     * @return: type: []
     */
    ...
    /*
     * Function Name : insert_credit()
     * Wroking :This function is used for insertting the admin credits.
     * @author:Rabeesh
     * @param :[]
     * @return: type: [Boolean]
     */
    ...
    /*
     * Function Name : alladmincredit()
     * Wroking :This function is used for viewing all admin credits.
     * @author:Rabeesh
     * @param :[]
     * @return: type: [Boolean]
     */
     ...
     * Wroking :This function is used for deleting a perticular tasks.
     * @author:Rabeesh
