...
class Batch extends Controller {
    ...
    function index($type='center', $item_id = 0) {
        ...
        if ($type == 'center') {
            ...
            if ($all_batches)
                $center_id = $all_batches[0]->center_id;
            else
    ...
    /*
     * Function Name : add_volunteers()
     * Wroking :Get Batch details,Levels,All teachers.
     * @author:Rabeesh
     * @param :[]
     * @return: type: []
     */
    ...
    /*
     * Function Name : add_volunteers_action()
     * Wroking :Save the details of the old volunteers in the batch/level.
    ...
    function add_volunteers_action() {
        ...
        foreach ($teacher_levels as $level_id => $teacher_ids) {
            ...
            foreach ($delete_future_class_of as $user_id)
    ...
    /*
     * Function Name : create_action()
     * Wroking :Create Batch action class
     * @author:Rabeesh
     * @param :[]
     * @return: type: []
     */
    ...
    /*
     * Function Name : edit()
     * Wroking :Function for showing editting window for batch.
     * @author:Rabeesh
     * @param :[$batch_id]
     * @return: type: []
     */
    ...
    /*
     * Function Name : edit_action()
     * Wroking :Function for editting batch.
     * @author:Rabeesh
     * @param :[]
     * @return: type: []
     */
     ...
     * Wroking :Delete a batch from a perticluar city.
     * @author:Rabeesh
     * @param :[$batch_id]
     * @return: type: []
     */
