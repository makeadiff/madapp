...
class Common extends Controller {
     ...
     * Wroking :Function used for registration
     * @author:Rabeesh
     * @param :[$user_id_encoded]
     * @return: type: []
     */
     ...
     * Wroking  :Function used for after registration it will show the thank you page
     * @author  :Rabeesh
     * @param   :[]
     * @return  : type: []
     */
    ...
    /*
     * Function Name : sms_response()
     * Wroking :Handle the responses sent as the reply to the confirmation text here.
     * @author:Rabeesh
     * @param :[]
     * @return: type: []
     */
    ...
    /*
     * Function Name : sms_register()
     * Wroking :SMS Registerations.
     * @author:
     * @param :[]
     * @return: type: []
     */
    ...
    function sms_register() {
        ...
        if ($debug)
            print "$city:$full_name:$name:$email<br />";
        ...
        if ($user) {
            ...
            $log .= print_r($user, 1);
            if ($debug)
                print "User Exists...<br />" . print_r($user, 1);
        } else {
            // Then sent a thank you sms to that user.
            if (!$debug)
    ...
    function runners() {
        ...
        foreach ($cities as $city_name) {
            ...
            foreach ($roles as $role) {
                ...
                if ($user_id)
                    $this->users_model->adduser_to_group($user_id, array($role['group_id']));
