...
class Class_model extends Model {
     ...
     * Wroking :This function return all class details.
     * @author:
     * @param :[$user_id]
     * @return: type: [array]
     */
    ...
    /*
     * Function Name : get_all_by_batch()
     * Wroking :This function return all class details for given project and batch.
     * @author:
     * @param :[$batch_id]
     * @return: type: [array]
     */
    ...
    /*
     * Function Name : confirm_class()
     * Wroking :This function update the class as confirmed
     * @author:
    ...
    /*
     * Function Name : cancel_class()
     * Wroking :Sets the status of all the teacher in the set class as cancelled. Used to cancel a class.
     * @author:
     * @param :[$class_id]
     * @return: type: [boolean]
     */
    ...
    /*
     * Function Name : delete_future_classes()
     * Wroking :Deletes the future classes of the given user - happens when a user is taken off a batch.
     * @author:
    ...
    /*
     * Function Name : uncancel_class()
     * Wroking :Revert a class cancellation. The status becomes projected.
     * @author:
     * @param :[$class_id]
     * @return: type: [boolean]
     */
    ...
    /*
     * Function Name : get_last_class_in_batch()
     * Wroking :return the last class in the batch.
     * @author:
     * @param :[$batch_id]
     * @return: type: [array]
     */
    ...
    /*
     * Function Name : get_last_class_in_batch()
     * Wroking :Returns the last unit taught in that level/batch.
     * @author:
     * @param :[$level_id, $batch_id]
     * @return: type: [boolean]
     */
    ...
    function get_last_unit_taught($level_id, $batch_id=0) {
        $batch_condition = '';
        if ($batch_id)
            $batch_condition = "batch_id=$batch_id AND ";
        ...
        if ($class)
            return $class->lesson_id;
        return 0;
    }

    /*
     * Function Name : get_last_class_in_batch()
     * Wroking :Try to find the class if the necessay data. Any class can be identified with the batch_id, level_id and the time of the class.
     * If the class is not found, create one.Add the given user to the class.
     * @author:
     * @param :[$data]
     * @return: type: [boolean]
     */
    ...
    /*
     * Function Name : save_class_lesson()
     * Wroking :This function save the class lesson.
     * @author:
    ...
    /*
     * Function Name : get_classes_by_level()
     * Wroking :Get just the class information for the current level
     * @author:
     * @param :[$level_id]
     * @return: type: [array]
     */
    ...
    /*
     * Function Name : get_classes_by_level_and_batch()
     * Wroking :Get just the class information for the current level/batch.
     * @author:
     * @param :[$level_id, $batch_id]
     * @return: type: [array]
     */
    ...
    /*
     * Function Name : get_by_level()
     * Wroking :Get both teacher information and class information together.
     * @author:
     * @param :[$level_id]
     * @return: type: [array]
     */
    ...
    /*
     * Function Name : get_by_batch_level_time()
     * Wroking :Returns the class id.
     * @author:
     * @param :[$batch_id, $level_id, $class_on]
     * @return: type: [array]
     */
    ...
    /*
     * Function Name : get_by_teacher_time()
     * Wroking :Returns classes by given teacher id and time.
     * @author:
     * @param :[$teacher_id, $time]
     * @return: type: [array]
     */
    ...
    /*
     * Function Name : get_attendence()
     * Wroking :The the absent/present status of the kids of any perticular class.
     * @author:
     * @param :[$class_id]
     * @return: type: [array]
     */
    ...
    /*
     * Function Name : save_attendence()
     * Wroking :This function Save the attendance into database
     * @author:
     * @param :[$class_id, $all_students, $attendence]
     * @return: type: [array]
     */
    ...
    /*
     * Function Name : is_class_teacher()
     * Wroking :See if the given class has a teacher with the giver user id. Returns true if yes. False otherwise
     * @author:
     * @param :[$class_id, $user_id]
     * @return: type: [array]
     */
     ...
     * Wroking :This function returns the class and teacher details.
     * @author:
     * @param :[$class_id]
     * @return: type: [array]
     */
    ...
    /*
     * Function Name : save_class_teachers()
     * Wroking :This function save the teachers.Sometimes, the UserClass.id is not provided. Then we find the unique row using UserClass.class_id and UserClass.user_id. Then cache its UserClass.id
     * When editing the class info, make sure that the credits asigned during the last edit is removed...
     * @author:
     * @param :[$user_class_id, $data]
     * @return: type: [array]
     */
    ...
    /*
     * Function Name : calculate_users_class_credit()
     * Wroking :Calculates the credit that should be given to the user for the given class.
     * @author:
     * @param :[$user_class_id - the id of a row in the UserClass table.]
     * @return: type: [array]
     */

    function calculate_users_class_credit($user_class_id, $data = array()) {
        if (!$data or empty($data->class_id))
            $data = $this->db->where('id', $user_class_id)->get('UserClass')->row_array();
        ...
        if ($status == 'attended') {
            if ($substitute_id) {
                ...
                if ($debug)
                    print "<br />Substitute attended. Sub +$credit_sub_gets and Teacher -1";
            }
            ...
            if ($substitute_id) {
                ...
                $this->user_model->update_credit($user_id, -1);
                if ($debug)
                    print "<br />Substitute was absent. Sub -2 and Teacher -1";
            } else {
                // Absent without substitute. Teacher loses two credit.
                $this->user_model->update_credit($user_id, -2);
                if ($debug)
                    print "<br />Teacher was absent. Teacher -2";
            }
        }
    }

    /*
     * Function Name : revert_user_class_credit()
     * Wroking :When editing the class info, we have to make sure that the credits asigned durring the last edit is removed. Thats what this function is for.
     * @author:
     * @param :[$user_class_id]
     * @return: type: [array]
     */
    ...
    function revert_user_class_credit($user_class_id, $data = array()) {
        ...
        if ($status == 'attended') {
            if ($substitute_id) {
                ...
                $this->user_model->update_credit($user_id, 1);
                if ($debug)
                    print "<br />Substitute had attended. Reverting means Sub -$credit_sub_gets and Teacher +1";
            }
        } elseif ($status == 'absent') {
            if ($substitute_id) {
                ...
                $this->user_model->update_credit($user_id, +1);
                if ($debug)
                    print "<br />Substitute was absent. Reverting means Sub +2 and Teacher +1";
            } else {
                // Absent without substitute. Teacher lost two credit. So, give them +2.
                $this->user_model->update_credit($user_id, +2);
                if ($debug)
                    print "<br />Teacher was absent. Reverting Teacher +2";
            }
        }
    }

    /*
     * Function Name : get_unconfirmed_classes()
     * Wroking :Returns all the unconfirmed classes for the next $days days. 
     * @author:
     * @param :[$days]
     * @return: type: [array]
     */
    ...
    /*
     * Function Name : get_upcomming_classes()
     * Wroking :Return all the upcoming classes of the given user. Projected or confirmed. 
     * @author:
     * @param :[$user_id]
     * @return: type: [array]
     */
    ...
    /*
     * Function Name : get_closest_unconfirmed_class()
     * Wroking :Returns the closest unconfirmed class. This is the class that get 'confirmed' when a user replies to a text we send. 
     * @author:
     * @param :[$user_id]
     * @return: type: [array]
     */
    ...
    /*
     * Function Name : search_classes()
     * Wroking :Returns the classes.
     * @author:
     * @param :[$user_id]
     * @return: type: [array]
     */
    ...
    /*
     * Function Name : add_class_manually()
     * Wroking :This function save class manualy.
     * @author:
     * @param :[$level_id, $batch_id, $class_on, $user_id]
     * @return: type: [array]
     */
     ...
     * Wroking :This function delete the given class
     * @author:
     * @param :[$class_id]
     * @return: type: []
     */
    ...
    /*
     * Function Name : get_classes_by_level_and_center()
     * Wroking :Get just the class information for the current level/batch
     * @author:
     * @param :[$level_id]
     * @return: type: []
    ...
    /*
     * Function Name : get_classes_in_month()
     * Wroking :Returns the classes that happened in the given month.
     * @author:
     * @param :[$year_month, $city_id=0, $project_id]
     * @return: type: []
     */
    ...
    /*
     * Function Name : get_attendance_in_month()
     * Wroking :Returns the attendance of classes that happened in the given month.
     * @author:
     * @param :[$year_month, $city_id=0, $project_id=1]
     * @return: type: []
     */
    ...
    /*
     * Function Name : get__kids_attendance()
     * Wroking :This function returns kids attendance
     * @author:Rabeesh
     * @param :[$class_id]
     * @return: type: []
     */
    ...
    /*
     * Function Name : get_examname_by_level_and_center()
     * Wroking :Get just the class information for the current level/batch
     * @author:Rabeesh
     * @param :[$level_id]
     * @return: type: []
    ...
    /*
     * Function Name : get__student_marks()
     * Wroking :Get just the students marks
     * @author:Rabeesh
     * @param :[$exam,$students]
     * @return: type: []
     */
    ...
    /*
     * Function Name : get__student_attendence()
     * Wroking :Get just the students attendance
     * @author:Rabeesh
     * @param :[$kids_id]
     * @return: type: []
     */
