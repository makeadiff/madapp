...
class Ion_auth_model extends CI_Model {
     ...
     * @author:Rabeesh
     * @param :[$identity, $password, $remember=FALSE]
     * @return: type: [array]
     */
     ...
     * Wroking :This function used for return user details for a given user
     * @author:Rabeesh
     * @param :[$id = false]
     * @return: type: [array]
     */
 ...
 /*
     ...
     * Wroking :This function used for return user email details for a given user email
     * @author:Rabeesh
     * @param :[$email]
     * @return: type: [array]
     */
...
/*
     ...
     * Wroking :This function used for update last login
     * @author:Rabeesh
     * @param :[$id]
     * @return: type: [array]
     */
   ...
   /*
     ...
     * Wroking :This function used for setting language.
     * @author:Rabeesh
     * @param :[$lang]
     * @return: type: [array]
     */
    public function set_lang($lang = 'en') {
     ...
     /*
     * Function Name : login_remembered_user()
     * Wroking :This function used for remember current login.
     * @author:Rabeesh
     * @param :[$lang]
     * @return: type: [array]
     */
     ...
     * Wroking :This function used for generate temporory code for forgotten password. 
     * @author:Rabeesh
     * @param :[$lang]
     * @return: type: [array]
     */
    ...
    /*
     * Function Name : get_user_by_identity()
     * Wroking :This function used for get user by email.
     * @author:Rabeesh
     * @param :[$identity]
     * @return: type: [array]
     */
    ...
    /*
     * Function Name : forgotten_password_complete()
     * Wroking :This function used for reset the user password.
     * @author:Rabeesh
     * @param :[$code]
     * @return: type: [array]
     */
