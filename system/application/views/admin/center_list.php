...
<!-- Main Begins -->
	<div id="main" class="clear">
    	<div id="head" class="clear">
            ...
            <!-- start page actions-->
        	<div id="actions"> 
<a href="<?= site_url('admin/popupaddCneter')?>" class="thickbox button primary" id="example" name="<strong>Add New Center</strong>">Add New Center</a>
</div>
			<!-- end page actions-->
...
-->    <td class="colCheck1"><a href="#"><?php echo $i; ?></a></td>
    ...
    <a href="<?= site_url('admin/popupEdit_center/'.$row['id'])?>" class="thickbox" style="cursor:pointer;background-image:url(<?php echo base_url(); ?>/images/ico/icoEdit.png)" id="group-<?php echo $row['id']; ?>" name="<strong>Edit Center : <?= strtolower($row['name']) ?></strong>">Edit</a> 
