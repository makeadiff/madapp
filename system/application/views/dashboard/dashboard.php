...
<div id="quick" class="clear" style="margin-top:-15px;">
	...
	<?php if($this->user_auth->check_permission('center_index')) { ?>
	...
	<?php if($this->user_auth->check_permission('kids_index')) { ?>
	...
	<?php if($this->user_auth->check_permission('exam_index')) { ?>
	...
	<?php if($this->user_auth->check_permission('exam_marks_index')) { ?>
	...
	<?php if($this->user_auth->check_permission('users_index')) { ?>
	...
	<?php if($this->user_auth->check_permission('user_group_index')) { ?>
