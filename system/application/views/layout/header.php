...
<div id="buttons"><a href="<?php echo site_url('auth/logout') ?>" class="button tool" style="margin-left: 10px; float:right;">Logout</a><a href="<?php echo site_url('user/edit_profile') ?>" class="button tool" style="margin-left: 10px; float:right;">EditProfile</a></div>
