...
<a href="<?php echo site_url('national_dashboard/exam_table_of_all_cities') ?>">Exams</a><br />
<a href="<?php echo site_url('national_dashboard/starters_table_of_all_cities') ?>">Starters</a><br />
