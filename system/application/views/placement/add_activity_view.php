...
<tr>
	...
	<th class="colName sortable">Activity Name</th>
...
<tr class="<?php echo $shadeClass; ?>" id="group">
    ...
    <a href="<?php echo site_url('placement/popupEdit_activity/'.$row['id'])?>" class="thickbox icon popup edit">Edit</a>
    <a class="actionDelete icon delete confirm" href="<?php echo site_url('placement/ajax_deleteactivity/'.$row['id']); ?>">Delete</a>
    </td>
</tr>
