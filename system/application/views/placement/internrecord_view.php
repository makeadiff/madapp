...
<script type="text/javascript">
    function getcount(id) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('placement/internrecord_activity') ?>/"+gid,
...
<div id="wrapper">
    <div id="container">
        <table id="tableItems" class="clear data-table" cellpadding="0" cellspacing="0">
            <thead>
                <tr>
                    <th class="colCheck1">Intern Name</th>
                    <th class="colName sortable">Total No: of activities conducted</th>
